...
test_that("plot_predictions_truth_scatter returns a ggplot", {
  skip_if_not_installed("ggplot2")
  set.seed(1)
  truth <- rnorm(50)
  p <- plot_predictions_truth_scatter(
...
test_that("plot_predictions_truth_scatter drops NA/NaN/Inf pairs", {
  skip_if_not_installed("ggplot2")
